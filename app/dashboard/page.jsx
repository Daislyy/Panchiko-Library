    ...
    <main className="min-h-screen bg-[#2e2e2e] text-white font-[Merriweather] ">
      ...
      <div className="flex pt-16">
        ...
        <div className="flex-1 ml-64">
          ...
          <section id="Book" className="bg-white text-black px-8 md:px-20 py-20">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 max-w-7xl mx-auto">
                {books.map((book) => (
                  <Link
                    ...
                    className="block"
                  >
                    <div className="bg-white border border-gray-200 rounded-lg p-6 text-center shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-2 flex flex-col h-full cursor-pointer group">
                      ...
                      <div className="bg-green-400 hover:bg-green-500 text-black font-semibold py-3 px-8 rounded-md transition-colors w-full mt-auto group-hover:bg-green-500">
                        Pinjam Buku
                      </div>
                    </div>
                  </Link>
